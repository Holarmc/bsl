...
<img alt="BSL Infrastructure" className="w-full h-full object-cover" data-alt="A sophisticated macro shot of modern server racks in a data center with glowing blue and green status lights. The image features a clean, high-tech aesthetic with sharp focus and shallow depth of field, reflecting enterprise-grade reliability. The lighting is cold and professional, dominated by corporate blues and technical grays." src="https://res.cloudinary.com/dumgkpy4c/image/upload/v1778454250/Image_txnkq8.jpg"/>
</div>
...
<span className="inline-block px-4 py-1 rounded-full bg-primary-container/10 text-primary font-label-sm uppercase tracking-widest">Enterprise IT Solutions</span>
<h1 className="font-h1 text-h1 text-on-background">Engineering Reliable IT. <span className="text-primary">Powering Business Growth.</span></h1>
...
<button onClick={() => router.push('/contacts')}  className="bg-primary text-on-primary px-8 py-4 rounded-xl font-bold shadow-lg hover:translate-y-[-2px] transition-all">
                            Get a Free Consultation
                        </button>
<button onClick={() => router.push('/services')}  className="border-2 border-on-background text-on-background px-8 py-4 rounded-xl font-bold hover:bg-on-background hover:text-white transition-all">
...
<img className="rounded-2xl w-full h-auto" data-alt="A clean, minimalist digital dashboard displaying real-time IT network performance metrics and migration status bars in vibrant green and blue. The user interface looks professional and corporate, with generous white space and sharp typography. The background is a soft, light-mode gray that recedes into the distance." src="https://res.cloudinary.com/dumgkpy4c/image/upload/v1778454251/logoM_BSLtext_h8eaif.png"/>
</div>
<div className="absolute -bottom-10 -left-10 glass-card p-6 rounded-2xl shadow-xl max-w-xs">
<div className="flex items-center gap-3 mb-2">
<span className="material-symbols-outlined text-secondary" style={{fontVariationSettings: 'FILL'}}>check_circle</span>
...
<a className="inline-flex items-center gap-2 font-bold underline group-hover:no-underline" href="#">Learn More <span className="material-symbols-outlined">arrow_forward</span></a>
</div>
{/* <!-- Migration Services --> */}
<div className="group p-stack-lg rounded-3xl bg-surface-container-low hover:bg-primary hover:text-on-primary transition-all duration-300 shadow-sm">
...
<img className="rounded-3xl shadow-xl w-full" data-alt="A diverse team of corporate professionals engaged in a hands-on IT training session. They are gathered around high-end laptops in a modern, brightly lit office space. A digital screen in the background shows complex network diagrams in vibrant green and blue. The atmosphere is collaborative, professional, and focused on learning." src="https://res.cloudinary.com/dumgkpy4c/image/upload/v1778454288/logo_Large_wv0y7i.png"/>
...
<button onClick={() => router.push('/training')}  className="bg-on-background text-white px-8 py-4 rounded-xl font-bold hover:opacity-90 transition-all flex items-center gap-2">
...
<button onClick={() => router.push('/contacts')}  className="bg-white text-primary px-10 py-4 rounded-xl font-bold hover:bg-opacity-90 transition-all">Schedule a Consultation</button>
<button onClick={() => router.push('/training')}  className="border-2 border-white text-white px-10 py-4 rounded-xl font-bold hover:bg-white hover:text-primary transition-all">Contact Us Today</button>
</div>
</div>
</section>
</main>
